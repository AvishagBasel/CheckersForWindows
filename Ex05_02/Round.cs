...
namespace Ex05_02
{
    public class Round
    {
        ...
        private ePlayerNumber m_CurrentTurnPlayer = ePlayerNumber.Player1;
        private ePlayerNumber LastTurnPlayer { get; set; }
        private ePlayerNumber Winner { get; set; }
        private bool m_RoundIsOver;
        ...
        public event Action<Round> BecameInitialized;
        public event Action<Round> CurrentTurnPlayerChanged;
        public event Action BecameOver;
        ...
        public ePlayerNumber CurrentTurnPlayer
        {
            get
            {
            ...
            set
            {
                ...
                OnCurrentTurnPlayerChanged(this);
            }
        }
        ...
        public void InitRound()
        {
            ...
            OnBecameInitialized(this);
        }

        protected virtual void OnBecameInitialized(Round i_Round)
        {
            if(BecameInitialized != null)
            {
                BecameInitialized.Invoke(i_Round);
            }
        }
        ...
        protected virtual void OnCurrentTurnPlayerChanged(Round i_Round)
        {
            if(CurrentTurnPlayerChanged != null)
            {
                CurrentTurnPlayerChanged.Invoke(i_Round);
            }
        }
        ...
        protected virtual void OnBecameOver()
        {
            if(BecameOver != null)
            {
                BecameOver.Invoke();
        ...
        private static void computeScore(Player i_Winner, Player i_Loser)
        {
